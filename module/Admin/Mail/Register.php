...
$message = '
  ...
  <br>
  <p>Вы успешно зарегистрировались на сайте <a href="' . $site_url . '" target="_blank">' . Setting::get('site')->name . '</a>.</p>
  ...
  <br>
  <p>С уважением,<br>Администрация <a href="' . $site_url . '" target="_blank">' . Setting::get('site')->name . '</a></p>
';
